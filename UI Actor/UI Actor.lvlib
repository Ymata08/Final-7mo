...
<Library LVVersion="20008000">
	...
	<Property Name="NI.Lib.Description" Type="Str">The UI Actor is the user interface that is displayed after choosing through the launcher with which of the two microcontrollers we want to operate. It contains the main commands with which we operate the microcontrollers and through its actor messages we have been able to link the AF with the project and HAL.</Property>
	...
	<Item Name="Messages for this Actor" Type="Folder">
		<Item Name="visa Init Msg.lvclass" Type="LVClass" URL="../../UI Actor Messages/visa Init Msg/visa Init Msg.lvclass"/>
	</Item>
